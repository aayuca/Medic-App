package com.acem.medicapp.androidim;
...
import com.acem.medicapp.androidim.services.IMService;
...
public class SignUp extends Activity {
					...
					if (passwordText.getText().toString().equals(passwordAgainText.getText().toString())) {
						...
						if (usernameText.length() >= 5 && passwordText.length() >= 5) {
							...
							Thread thread = new Thread() {
								...
								@Override
								public void run() {
									result = imService.signUpUser(usernameText.getText().toString(), passwordText.getText()
	...
	protected Dialog onCreateDialog(int id) {
		...
		case TYPE_SAME_PASSWORD_IN_PASSWORD_FIELDS:
			return new AlertDialog.Builder(SignUp.this).setMessage(R.string.signup_type_same_password_in_password_fields)
